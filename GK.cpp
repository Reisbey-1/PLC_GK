// GK.cpp : Legt das Klassenverhalten für die Anwendung fest.
//
...
BEGIN_MESSAGE_MAP(CGKApp, CWinApp)
	//{{AFX_MSG_MAP(CGKApp)
...
/////////////////////////////////////////////////////////////////////////////
// Das einzige CGKApp-Objekt

CGKApp theApp;

/////////////////////////////////////////////////////////////////////////////
// CGKApp Initialisierung

BOOL CGKApp::InitInstance()
{
...
/**/	
	...
	pDocTemplate = new CMultiDocTemplate(
		IDR_GKTYPE,
		RUNTIME_CLASS(CGKDoc),
		RUNTIME_CLASS(CChildFrame), // Benutzerspezifischer MDI-Child-Rahmen
		RUNTIME_CLASS(CLeftView));
	pDocTemplate->SetContainerInfo(IDR_GKTYPE_CNTR_IP);
...
/////////////////////////////////////////////////////////////////////////////
// CGKApp-Nachrichtenbehandlungsroutinen
